...
const game1 = new Game(
  ...
  "Multi",
  "https://upload.wikimedia.org/wikipedia/en/thumb/e/e8/MassEffect.jpg/220px-MassEffect.jpg"
);
const game2 = new Game(
  ...
  ["Action", "RPG", "Adventure"],
  "Multi",
  "https://upload.wikimedia.org/wikipedia/en/thumb/0/05/MassEffect2_cover.PNG/220px-MassEffect2_cover.PNG"
);
const game3 = new Game(
  ...
  ["Action", "RPG", "Adventure"],
  "Multi",
  "https://upload.wikimedia.org/wikipedia/en/thumb/b/b0/Mass_Effect_3_Game_Cover.jpg/220px-Mass_Effect_3_Game_Cover.jpg"
);
const game4 = new Game(
  ...
  ["Platform", "Action"],
  "Wii",
  "https://upload.wikimedia.org/wikipedia/en/thumb/6/65/Super_Mario_Galaxy_2_Box_Art.jpg/220px-Super_Mario_Galaxy_2_Box_Art.jpg"
);
...
const book1 = new Book(
  ...
  ["Fiction"],
  "Helen DeWitt",
  "https://upload.wikimedia.org/wikipedia/en/thumb/8/89/HelenDeWitt_TheLastSamurai.jpg/220px-HelenDeWitt_TheLastSamurai.jpg"
);
const book2 = new Book(
  ...
  ["Fiction"],
  "Paul Beatty",
  "https://upload.wikimedia.org/wikipedia/en/thumb/8/81/Sellout_by_Paul_Beatty.jpg/220px-Sellout_by_Paul_Beatty.jpg"
);
const book3 = new Book(
  ...
  ["Fiction"],
  "Maggie Nelson",
  "https://images-na.ssl-images-amazon.com/images/I/71ZlOEHnHqL.jpg"
);
